...
{
    /// <summary>
    /// Contains code to convert Mappings to a Json-serializable model
    /// </summary>
    internal static class MappingConverter
    {
        ...
        public static MappingModel ToMappingModel(Mapping mapping)
        {
            ...
            return ToMappingModel(request, response, mapping.Guid, mapping.Title, mapping.Priority);
        }

        public static MappingModel ToMappingModel(Request request, Response response, Guid guid, 
        ...
        internal static MatcherModel[] Map([CanBeNull] IEnumerable<IMatcher> matchers)
        {
        ...
        internal static MatcherModel Map([CanBeNull] IMatcher matcher)
        {
            if (matcher == null)
                return null;
        ...
        internal static string[] Map<T>([CanBeNull] IEnumerable<Func<T, bool>> funcs)
        {
        ...
        internal static string Map<T>([CanBeNull] Func<T, bool> func)
        {
            return func?.ToString();
        }

        internal static IMatcher Map([CanBeNull] MatcherModel matcher)
        {
            if (matcher == null)
                return null;
